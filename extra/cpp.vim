...
if exists('g:cpp_class_scope_highlight') && g:cpp_class_scope_highlight
    ...
    hi! cCustomClass guifg=#acf2e4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
endif
...
" Override some styles. Idk where else to do it but here
hi! cppSTLnamespace guifg=#acf2e4 guibg=NONE guisp=NONE gui=NONE cterm=NONE 
