...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi PinkUnderlined guifg=#ff7ab2 guibg=NONE guisp=NONE gui=underline cterm=underline
  hi Purple guifg=#b281eb guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi! link cppModifier PinkUnderlined
  ...
  if g:xcodedark_emph_funcs
    ...
    hi LocalFunc guifg=#4eb0cc guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#4eb0cc guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi FunctionDef guifg=#4eb0cc guibg=NONE guisp=NONE gui=NONE cterm=NONE
